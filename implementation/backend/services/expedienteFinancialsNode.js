// ============================================================================
// expedienteFinancialsNode.js — Cálculo económico de un expediente en BACKEND.
// ----------------------------------------------------------------------------
// Reutiliza la MATEMÁTICA real del frontend (calculation.js, importado por ESM
// dinámico: es matemática pura sin dependencias de navegador y el frontend es
// "type": "module"). Solo se replica aquí el MAPEO de campos exp→args, que es
// espejo de features/expedientes/logic/expedienteFinancials.js.
// Se usa en el portal del cliente para expedientes SIN snapshot result.financials
// (p.ej. migrados desde XML). NO expone profit; el portal solo usa `cae`.
// ============================================================================
...
async function computeExpedienteFinancialsNode(exp, op) {
    ...
    let cae = null, profit = null, savingsKwh = null;
...
module.exports = { computeExpedienteFinancialsNode };
