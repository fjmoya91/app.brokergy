...
const ANEXO_ACTUACIONES = [
    {
        ...
        despues: ['FOTO_UNIDAD_EXTERIOR', 'FOTO_UNIDAD_EXTERIOR_PLACA', 'FOTO_UNIDAD_INTERIOR', 'FOTO_UNIDAD_INTERIOR_PLACA', 'FOTO_ARMARIO_SUELO_RADIANTE', 'FOTO_ACS_DEPOSITO', 'FOTO_HIBRIDACION', 'FOTO_CALDERA_DESMONTADA'],
    },
    {
        id: 'ventanas',
