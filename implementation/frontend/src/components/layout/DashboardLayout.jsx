                ...
                <nav className="relative z-10 flex-1 min-h-0 overflow-y-auto overscroll-contain px-4 pb-2 space-y-1">
                    {(() => {
                        ...
                        const ENTRADAS = [
                            ...
                            { id: 'cee-directos', grupo: 'cartera', label: 'CEE directos', ver: isStaff || isCertificador,
                              title: 'Certificados de eficiencia energética contratados sueltos',
                            ...
                            // Las respuestas del formulario de cobro. Va en CARTERA y no en
                            // "hoy": es trabajo comercial, no tramitación, y mezclarlo con el
                            // parte de atascos diluiría lo que hace útil al parte (que todo lo
                            // que sale ahí es un expediente parado). La ve todo el staff — no
                            // lleva un solo importe, así que no es ADMIN-only.
                            { id: 'venta-cruzada', grupo: 'cartera', label: 'Venta cruzada', ver: isStaff,
                              title: 'Lo que contestan los clientes al confirmar sus datos de cobro: quién quiere estudio de tarifa, placas o la deducción',
