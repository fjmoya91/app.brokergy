    ...
    return (
        <SectionCard className="h-full">
            ...
            <div className="space-y-4">
                ...
                <div>
                    <h3 className="text-sm font-semibold text-lime-400 mb-3 uppercase tracking-wider">Instalaciones y Mejoras</h3>
                    ...
                    <div className="mt-6 p-4 rounded-xl bg-gradient-to-br from-amber-900/20 to-orange-900/20 border border-amber-500/20">
                        <div className="flex items-center justify-between">
                            <h4 className="text-xs font-bold text-amber-400 uppercase tracking-wider flex items-center gap-2">
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                Descuento 100% Certificados de Eficiencia Energética
                            </h4>
                    ...
                    <div className="mt-6 p-4 rounded-xl bg-gradient-to-br from-emerald-900/20 to-cyan-900/20 border border-emerald-500/20">
                        ...
                        {inputs.includeAnnualSavings && (
                            <div className="animate-fade-in">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
                                    <div>
                                        <Label htmlFor="fuelType">Combustible actual</Label>
                                        <Select
                                            id="fuelType"
                                    ...
                                    <div>
                                        <Label htmlFor="fuelPrice">Precio (€/kWh)</Label>
                                        <div className="relative group">
                                            <Input
                                                ...
                                                className={isPriceLocked ? 'opacity-60 bg-slate-900/50 cursor-not-allowed border-slate-800' : 'border-cyan-500/50'}
                                            />
                                            <button
                                                type="button"
                                                onClick={() => setIsPriceLocked(!isPriceLocked)}
                                                className="absolute right-3 top-1/2 -translate-y-1/2 px-2 py-1 rounded bg-slate-800/80 text-[10px] font-bold uppercase tracking-wider text-cyan-400 hover:text-cyan-300 hover:bg-slate-700 transition-all border border-white/5"
                                            >
                                ...
                                {inputs.savingsMode === 'real' && (
                                    <div className="animate-fade-in">
                                        <Label htmlFor="gastoAnualReal">Gasto anual estimado (€)</Label>
                                        <Input
                                            id="gastoAnualReal"
                                            type="text"
                                            inputMode="decimal"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
                        <div className={!showBrokergy ? 'md:col-span-2' : 'md:col-span-2'}>
                            <div className={`grid grid-cols-1 ${showBrokergy ? 'md:grid-cols-3' : 'md:grid-cols-3'} gap-3`}>
                                <div className={showBrokergy ? 'md:col-span-1' : 'md:col-span-2'}>
                                    <Label htmlFor="presupuesto">{showBrokergy ? 'Presupuesto (€)' : 'Presupuesto instalación (€)'}</Label>
                                    <Input
                                        id="presupuesto"
                                        type="text"
                                        inputMode="decimal"
                                ...
                                <div>
                                    <Label htmlFor="numOwners">{showBrokergy ? 'Propietarios' : 'Nº Propietarios'}</Label>
                                    <Input
                                        id="numOwners"
                                        type="number"
                                        min={1}
                                ...
                                {showBrokergy && (
                                    <div className="animate-fade-in">
                                        <Label htmlFor="caePriceClient">CAE Cliente (€/MWh)</Label>
                                        <Input
                                            id="caePriceClient"
                                            type="number"
                                            inputMode="decimal"
                            ...
                            <div className="mt-2 flex items-center justify-end">
                                <label className="flex items-center gap-2 cursor-pointer group">
                                    <span className={`text-[10px] font-bold uppercase tracking-wider transition-colors ${inputs.includeIVA ? 'text-cyan-400' : 'text-slate-500'}`}>
                                        {inputs.includeIVA ? '+21% IVA INCLUIDO' : 'AÑADIR 21% IVA'}
                                    </span>
                                    <div className="relative flex items-center">
                                        <input
                                            type="checkbox"
                    ...
                    {showBrokergy && result && (
                        <div className="mt-2 p-5 rounded-2xl bg-slate-900/80 border-2 border-orange-500/40 flex flex-col gap-4 shadow-[0_0_20px_rgba(249,115,22,0.1)] animate-scale-in relative overflow-hidden">
                            {/* Decoración de fondo - Neón Naranja Intenso */}
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Input
                                                ...
                                                onChange={e => {
                                                    ...
                                                    // Opcionalmente podrías querer limitar que no supere el spread, 
                                                    // pero dejamos libertad al usuario.
                ...
                {/* Botón eliminado: el cálculo ahora es automático y en tiempo real */}
            </div>
        </SectionCard >
    );
}
