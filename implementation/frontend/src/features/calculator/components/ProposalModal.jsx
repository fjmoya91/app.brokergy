...
Puedes firmar la aceptación pulsando en el botón del PDF *“✍️ FIRMAR Y ACEPTAR PROPUESTA”* o directamente aquí: ${window.location.origin}/firma/${urlId}
...
El presupuesto lo puedes aceptar pulsando sobre el botón del PDF *“✍️ FIRMAR Y ACEPTAR PROPUESTA”* o bien directamente accediendo a ${window.location.origin}/firma/${urlId}
                        ...
                        <div ref={proposalRef} className="prop-wrapper-inner" style={{ fontFamily: 'var(--font-family)' }}>
                            ...
                            <div className={`prop-page${showAnnualSavings ? ' prop-compact' : ''}`}>
                                ...
                                <div className="prop-cta">
                                    ...
                                    <a href={`${window.location.origin}/firma/${urlId}`} target="_blank" rel="noopener noreferrer" className="prop-cta-btn">✍️&nbsp;&nbsp;FIRMAR Y ACEPTAR PROPUESTA</a>
