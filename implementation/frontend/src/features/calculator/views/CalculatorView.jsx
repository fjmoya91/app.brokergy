        ...
        <div className={`animate-fade-in text-white ${result?.financials?.caeBonus !== undefined ? 'md:pt-28 max-md:pb-28' : ''}`}>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div className="flex items-center gap-4">
                    ...
                    {/* Enlace al expediente (móvil): mismo destino que el botón desktop de la línea 779 */}
                    {associatedExpediente && user?.rol?.toUpperCase() === 'ADMIN' && (
                        <button
                            onClick={() => onNavigate('expedientes', { expediente_id: associatedExpediente.id })}
                            className="md:hidden flex items-center gap-1.5 px-3 py-1 bg-indigo-500/10 hover:bg-indigo-500/20 border border-indigo-500/30 rounded-full text-[9px] font-black text-indigo-400 uppercase tracking-widest transition-all"
