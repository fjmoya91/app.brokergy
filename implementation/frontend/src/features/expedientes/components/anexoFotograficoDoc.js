...
export const ANEXO_ACTUACIONES = [
    {
        id: 'aerotermia',
...
export function slotFromRowId(rowId) {
 ...
 */
export function groupRowsIntoActuaciones(rows) {
 ...
 */
export function buildAnexoPages(rows, meta, opts = {}) {
...
export function buildAnexoFullHtml(rows, meta, opts = {}) {
