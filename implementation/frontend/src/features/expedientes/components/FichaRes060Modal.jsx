...
export function FichaRes060Modal({ isOpen, onClose, expediente, results, onSaveDrive }) {
    ...
    const cifoDates060Modal = calcCifo(doc);
    // Mismos fallbacks que el CIFO (CertificadoCifoModal.jsx) para que la fecha coincida.
    const fechaInicio = formatFecha(cifoDates060Modal.inicio || doc.fecha_inicio_cifo || doc.fecha_visita_cee_inicial);
    const fechaFin    = formatFecha(cifoDates060Modal.fin    || doc.fecha_fin_cifo    || doc.fecha_firma_cee_final);
