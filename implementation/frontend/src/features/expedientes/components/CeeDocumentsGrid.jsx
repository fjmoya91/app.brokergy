...
function AutoconsumoDeclarable({ auto }) {
    ...
    return (
        <div className="w-full rounded-xl bg-brand/[0.07] border border-brand/25">
            <div className="flex flex-wrap items-center gap-x-3 gap-y-1.5 px-3 py-2.5">
                ...
                <button
                    type="button"
                    // Se copia el número a secas y con punto decimal: va a un
                    // formulario, no a un texto.
                    onClick={() => copiar(auto.kwhAnio.toFixed(2), '__kwh__')}
                    ...
                    return (
                        ...
                        <div key={section} className="flex flex-wrap items-center gap-x-5 gap-y-6 border-b border-white/[0.04] pb-12 last:border-0 last:pb-0 max-md:flex-col max-md:items-stretch max-md:gap-y-5 max-md:pb-8">
                            ...
                            {/* 2. Demanda Calefacción. La ⓘ de al lado cruza esta cifra y la
                                superficie con las que se simularon en la oportunidad (sobre las
                                que se ofreció el bono) y se pone en rojo si el CEE certifica
                                menos. Va detrás de un botón para no engordar la fila. */}
