                ...
                {['inicial', 'final'].map((section) => {
                    ...
                    return (
                        ...
                        <div key={section} className="flex flex-wrap items-center gap-x-5 gap-y-6 border-b border-white/[0.04] pb-12 last:border-0 last:pb-0 max-md:flex-col max-md:items-stretch max-md:gap-y-5 max-md:pb-8">
                            ...
                            <div className="flex flex-col items-center gap-2 w-[150px] border-l border-white/5 shrink-0 max-md:w-full max-md:flex-row max-md:items-center max-md:justify-between max-md:border-l-0 max-md:border-t max-md:border-white/[0.04] max-md:pt-4 max-md:mb-0">
                            ...
                            {/* 5. Documentos (slots) */}
                            <div className="flex items-center justify-between gap-2 pl-4 border-l border-white/5 w-[340px] shrink-0 max-md:w-full max-md:grid max-md:grid-cols-5 max-md:gap-1 max-md:items-end max-md:pl-0 max-md:border-l-0 max-md:border-t max-md:border-white/[0.04] max-md:pt-4">
